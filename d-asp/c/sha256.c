 ...
 */
void crypto_hmac_sha256(const uint8_t *key, size_t key_len, const uint8_t *data,
  ...
  // This part is simplified for brevity in RI, but would use a Context-based
  // hash for large data For D-ASP, payloads are usually small enough for simple
  // buffers
