...
interface ElectronAPI {
    ...
    dKaspEncrypt(mnemonic: string, keyHex: string, engine: string): Promise<unknown>;
    dKaspDecrypt(data: string, rk: string, keyOrPass: string, engine: string): Promise<unknown>;
